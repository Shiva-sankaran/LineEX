...
class CocoLine(torchvision.datasets.VisionDataset):
    ...
    def __getitem__(self, idx):
        ...
        #     image_file = "/home/vp.shivasan/data/data/ChartOCR_lines/line/images/val2019/"+str(db_rec['file_name'])
...
def build(image_set, args):
    ...
    if(image_set == "train"):
        ...
        ann_file = args.train_anno

    
    else:
        root = args.val_path
        ann_file = args.val_anno
    ...
    #     "val":('/home/vp.shivasan/data/data/ChartOCR_lines/line/annotations_cleaned/clean_instancesLine(1023)_val2019.json')  #('/home/vp.shivasan/data/data/ChartOCR_lines/line/annotations_cleaned/clean_instancesLine(1023)_val2019.json'),
