...
for image_name in tq.tqdm(os.listdir(image_path)):
    ...
    legend_bboxes, legend_text, legend_text_boxes, legend_ele_boxes,  xticks_info, yticks_info, unique_boxes = run_element_det(det_model, image_path, image_name, image_save_path)
