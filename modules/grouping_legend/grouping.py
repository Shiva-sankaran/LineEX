...
import numpy as np
import tqdm as tq
# os.chdir("/home/vp.shivasan/LineEX/modules")
sys.path.append("/home/vp.shivasan/LineEX/")
print(os.getcwd())
from PIL import Image, ImageDraw, ImageFont
from numpy import unravel_index
from modules.grouping_legend.legend_models.net import *
from modules.KP_detection.models.my_model import Model
import matplotlib.pyplot as plt
from modules.KP_detection.utils import *
from modules.grouping_legend.legend_models.MLP import legend_network
...
parser.add_argument('--test_path',default='/home/md.hassan/charts/s_CornerNet/synth_data/data/line/figqa/val/',help = "path to data (Ours, Adobe)")
...
for image_name in tq.tqdm(os.listdir(image_path)[:10]):
